import { IsString, Min, Max, IsNotEmpty, Length, IsDate, IsInt } from "class-validator";

// DTO para la creación de un nuevo hábito
export class CreateHabitDto {
  
  @IsInt({ message: 'El userId debe ser un entero.' }) // Validación: el userId debe ser un entero
